        ...
        <div className="relative bg-white rounded-xl shadow-lg p-8 max-w-md lg:w-120 w-full z-10">
          ...
          <div className="mt-6 flex items-center gap-2">
            <button
              ...
              className="bg-gray-100 text-gray-700 font-semibold py-2 px-4 rounded-full w-full hover:bg-indigo-900 hover:text-white focus:outline-none focus:shadow-outline lg:w-45 active:bg-gray-300"
            >
              DONOR
            </button>

            <button className="bg-indigo-950 text-white font-semibold py-2 px-4 rounded-full w-full hover:bg-indigo-900 focus:outline-none focus:shadow-outline lg:w-45 shadow-md">
              ADMINISTRATOR
            </button>
          </div>
          ...
          <form className="mt-8">
            ...
            <button
              ...
              className="bg-orange-400 hover:bg-orange-500 text-white font-bold py-2 px-4 rounded-xl focus:outline-none focus:shadow-outline w-full"
              type="button"
            >
              LOGIN
            </button>
