...
const LOGINADMIN = () => {
  ...
  return (
    <div className="p-0 m-0 min-h-screen bg-gray-300" id="BODY">
      ...
      >
        <div
          className="p-2 ml-5 flex flex-wrap items-center gap-3"
          id="LOGO&TEXT"
        >
        ...
        <div className="mr-3 flex" id="UPPER-LANDING-NAV">
          <h1 className="mr-10 font-bold text-xl text-white cursor-pointer hover:text-gray-300">
            ABOUT US
          </h1>
          <h1 className="font-bold text-xl text-white cursor-pointer hover:text-gray-300">
            CONTACT
          </h1>
        </div>
      </div>
