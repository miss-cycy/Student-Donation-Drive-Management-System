        ...
        <div className="p-0 m-0 h-screen bg-gray-300" id="BODY">
          ...
          >
            <div className="bg-white rounded-xl shadow-lg p-8 max-w-md lg:w-120 w-full">
              ...
              <div className="mt-6 flex-wrap gap-2">
                <button className="bg-gray-600 text-white font-semibold py-2 px-4 rounded-full w-full hover:bg-gray-500 focus:outline-none focus:shadow-outline lg:w-45 active:bg-gray-300 shadow-md">
                  DONOR
                </button>
                <a href="../LOGIN/login_admin.html">
                  <button className="bg-gray-100 text-gray-700 font-semibold py-2 px-4 rounded-full w-full hover:bg-gray-500 hover:text-white focus:outline-none focus:shadow-outline lg:w-45">
                    ADMINISTRATOR
                  </button>
                </a>
              </div>
